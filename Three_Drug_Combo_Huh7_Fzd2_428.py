...
results_df.to_csv("Three_Drug_Combo_Predictions_Huh7_1.csv")
...
results_df = pd.DataFrame(results)
results_df.to_csv("Three_Drug_Combo_Predictions_Huh7_2.csv")
...
results_df = pd.DataFrame(results)
results_df.to_csv("Three_Drug_Combo_Predictions_Huh7_3.csv")
...
results_df = pd.DataFrame(results)
results_df.to_csv("Three_Drug_Combo_Predictions_Huh7_4.csv")
...
results_df = pd.DataFrame(results)
results_df.to_csv("Three_Drug_Combo_Predictions_Huh7_5.csv")
